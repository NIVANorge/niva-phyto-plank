CREATE USER phytoplankton IDENTIFIED EXTERNALLY
...
(
    ...
    Lake varchar2(255 char),
    VannforekomstID varchar2(255 char),
    River_Basin_code varchar2(255 char),
    Lake_number varchar2(255 char),
    Altitude number,
    Mean_depth number,
    Max_depth number,
    Surface_area number,
    Lake_type varchar2(255 char),
    ICtypeID varchar2(255 char),
    Lake_type_code varchar2(255 char),
    Comments varchar2(255 char),
    SMWF varchar2(255 char),
...
(
    ...
    Stasjonskode varchar2(255 char),
    St_code varchar2(255 char),
    St_code_fag varchar2(10 char),
    Longitude number,
    Latitude number,
    Comments varchar2(255 char),
...
(
    ...
    StationID number not null,
    SampleDate date,
    Depths varchar2(255 char),
    Depth_1 number,
    Depth_2 number,
    Person varchar2(3 char),
    Comments varchar2(255 char),
...
(
    ...
    Bio_volume number,
    Counting_date date,
    Counting_level varchar2(55 char),
    Number_of_units number,
    Sample_type varchar2(255 char),
